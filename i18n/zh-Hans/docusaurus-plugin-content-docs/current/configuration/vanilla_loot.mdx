...
To solve this, our plugin provides a vanilla loot system override. Below is a quick-start example (where "..." represents loot configurations). For optimal results, we recommend reviewing [💎 Loot Table](../reference/loot_table.mdx) first to master loot configuration.
