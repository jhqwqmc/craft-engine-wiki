...
:::tip
这对高延迟玩家尤其有益，能显著提升方块放置体验。**尤其是对于PVP来说**。
...
:::tip
client-bound-data 对冒险模式中的玩家非常有用，它允许玩家在服务器端破坏某些真自定义方块。我建议在这里尽可能使用方块标签，而不是具体的方块id。这有助于解决一些客户端网络协议问题。
