...
## 3D 盔甲
<Highlight color="#0d9622ff">**1.21.6+**</Highlight><Highlight color="#0d9622ff">**基于着色器**</Highlight>

使用 [CraftEngine Toolbox](https://cech.gtemc.cn/)，可将 Blockbench `.bbmodel` 模型转换为兼容 CraftEngine 的 3D 盔甲资源包。

![使用 CraftEngine Toolbox 制作的 3D 盔甲](/img/3darmor.png)
