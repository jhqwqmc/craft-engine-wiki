...
| **l10n** | `<l10n:key>` | 服务端 | 各玩家客户端语言 | 消息、物品、GUI 等玩家可见内容 |
| **lang** | `<lang:key>` | 客户端（资源包） | 玩家的 Minecraft 语言设置 | 消息、物品、GUI 等玩家可见内容 |

---

## i18n 与 l10n：服务端翻译

i18n 和 l10n 共享**同一套数据源**，即 `translations` 配置节点。两者的区别在于选择语言的依据：
