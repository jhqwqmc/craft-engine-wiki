...
:::tip
对于高级 Skript 用户，请使用反射来实现更高级的功能。如果您在使用 Skript 时遇到问题，请及时向我们反馈。如果您想要请求新的 Skript 功能并且您了解 Java，请考虑通过拉取请求贡献您的代码！
:::

:::warning
请注意，如果您在加载服务器时遇到错误，这可能是因为 Skript 脚本在 CraftEngine 之前加载。目前无法修复此问题，只能通过重新加载来解决。
:::

## 事件

<SkriptCard
  title="放置/破坏 CraftEngine 方块事件"
  type="Event"
