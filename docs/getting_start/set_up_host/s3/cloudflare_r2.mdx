...
### Step 8
On the redirected page, locate the `Access Key ID` (to be used as `access_key_id`) and the `Secret Access Key` (to be used as `access_key_secret`). Finally, you should be able to compile the following configuration. \
