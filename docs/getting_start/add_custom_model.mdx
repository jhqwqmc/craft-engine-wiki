...
<Details summary="Answers" previewHeight={0}>
...
<Details summary="Custom Atlas Tutorial">
...
<Details summary="Mipmap Level 4 VS Mipmap Level 0">
...
<Details summary="What is CustomModelData?">
...
<Details summary="What is ItemModel?">
  ItemModel, introduced in 1.21.2, is a data component with better rendering efficiency than CustomModelData, reducing client-side performance overhead. Normally, you don’t need to manually specify the model path (item_model), as the plugin auto-generates it.
...
<Tabs>
  ...
  <TabItem value="display" label="🎨 display">
    ...
    Available values: `thirdperson_righthand`, `thirdperson_lefthand`, `firstperson_righthand`, `firstperson_lefthand`, `gui`, `head`, `ground`, `fixed`, or `on_shelf`.
