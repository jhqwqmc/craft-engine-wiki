...
<div style={{textAlign: 'center'}}>
  ...
  <p style={{fontSize: '0.9em', color: '#666', marginTop: '0.5em'}}>appearance state in use by manual allocation</p>
</div>

<div style={{textAlign: 'center'}}>
    <img src={require('/img/commands_7.png').default} alt="" />
    <p style={{fontSize: '0.9em', color: '#666', marginTop: '0.5em'}}>appearance state in use by automatic allocation</p>
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('/img/commands_4.png').default} alt="" />
    <p style={{fontSize: '0.9em', color: '#666', marginTop: '0.5em'}}>real state in use by manual allocation</p>
</div>

<div style={{textAlign: 'center'}}>
  <img src={require('/img/commands_5.png').default} alt="" />
  <p style={{fontSize: '0.9em', color: '#666', marginTop: '0.5em'}}>real state in use by automatic allocation</p>
</div>
