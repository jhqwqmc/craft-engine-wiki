...
CraftEngine ships with a JavaScript scripting system. Scripts can be referenced from YAML (as [functions](functions.mdx#js) and [conditions](conditions.mdx#js)), subscribe to Bukkit events, register recurring tasks, and provide custom [PlaceholderAPI placeholders](../compatibility/placeholderapi.mdx#cejs_id).
...
Scripts can be invoked from any place that accepts functions or conditions. See [js function](functions.mdx#js) and [js condition](conditions.mdx#js).
