...
pitch: <arg:position.pitch> # Default: <arg:position.pitch>
yaw: <arg:position.yaw> # Default: <arg:position.yaw>
...
furniture-id: "default:bench"
x: <arg:furniture.x> # Default: <arg:furniture.x>
y: <arg:furniture.y> # Default: <arg:furniture.y>
z: <arg:furniture.z> # Default: <arg:furniture.z>
pitch: <arg:furniture.pitch> # Default: <arg:furniture.pitch>
yaw: <arg:furniture.yaw> # Default: <arg:furniture.yaw>
anchor-type: ground # optional; enum[ground,ceiling,wall]
drop-loot: true # Default: true
play-sound: true # Default: true
```
