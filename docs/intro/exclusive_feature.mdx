...
CraftEngine doesn't hardcode note blocks or tripwires—you call the shots! Want to use any vanilla block state for custom blocks? Total creative freedom, zero leftovers. 🛠️✨
