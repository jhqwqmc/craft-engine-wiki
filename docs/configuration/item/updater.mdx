...
:::tip
If you only need to update visual elements of an item—such as custom_model_data, item_model, lore, or name—it is recommended to use `client_bound_data` instead of an item updater.
:::
