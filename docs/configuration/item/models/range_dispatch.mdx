...
Returns stack size (normalized or raw).
...
Returns damage value from `minecraft:damage` component (0 if absent or unbreakable).
...
Returns in-game time scaled 0.0–1.0.
