...
:::caution
When you use `minecraft:condition`, you need to specify the condition type, which is the **property** mentioned below. `on_false` and `on_true` respectively represent displaying different models under different conditions.
:::
