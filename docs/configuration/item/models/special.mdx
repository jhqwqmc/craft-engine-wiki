...
| `blueprint` | string | No | — | Blockbench `.bbmodel` file converted into the base model JSON <Highlight color="#FFA500">Experimental</Highlight> (see [Blueprint](model.mdx#blueprint-blockbench)) |
