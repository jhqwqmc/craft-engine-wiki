...
items#topaz_gears:
  default:topaz_rod:
    ...
    # If you specify a model in the legacy_model section,
...
:::tip
If you don't require support for versions above 1.21.4, you may configure only the legacy_model section and omit the model section entirely.
:::
