...
<UrlCard url="attribute/definition" title="🧩 Attribute Definition" subtitle="Base values, derived calculations, scheduled tasks, constraints, and vanilla synchronization" />
