...
Triggered when a player shears a block, such as a beehive or a pumpkin.
...
Triggered when a player shears an entity, such as a sheep, a mooshroom or a snow golem.
