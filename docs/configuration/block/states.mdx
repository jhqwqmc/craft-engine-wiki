...
> 💡 n most cases, you do not need to manually configure the ID. Only when you need to ensure that the internal ID remains fixed (for example, when using data packs or other systems that rely on strict ID mapping) should you set it manually.
