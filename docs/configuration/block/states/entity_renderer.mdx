...
The following parameters apply to `item_display`, `text_display`, and `block_display` display entity types.
...
Renders a vanilla block using the vanilla block display entity.
