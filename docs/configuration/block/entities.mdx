...
- A battery block that visually changes its model based on current energy level.
- A Stirling generator that runs on tick-based logic, periodically burning fuel to produce power.
...
<details>
<summary>Expand display parameter list</summary>
...
rotation: 45,45,0          # Euler angles (x,y,z)
rotation: 0,0,0.707,0.707  # Quaternion (x,y,z,w)
...
<details>
<summary>Example with tint source</summary>
...
:::info Requires the BetterModel plugin
:::
...
:::info Requires the ModelEngine plugin
:::
