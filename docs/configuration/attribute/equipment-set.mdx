...
`activate` and `deactivate` accept CraftEngine's general functions, including messages, commands, sounds, and groups of `run` functions. See [Functions](../../reference/functions.mdx) for every type.
