...
Conditions allow you to set requirements for this recipe, preventing players who do not meet them from crafting it.
...
default:topaz_bow:
  ...
  result:
    ...
    count: 1
    post-processors: [] # see the result post processor above
