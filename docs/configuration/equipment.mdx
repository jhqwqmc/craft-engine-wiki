...
<Details summary={<>How to fix the "removed" armor</>}>
...
Use the [CraftEngine Toolbox](https://cech.gtemc.cn/) to convert Blockbench `.bbmodel` files into CraftEngine-compatible 3D armor resource packs.

:::warning

This feature is based on core shaders and may break at any time because of a Minecraft update or a conflict with core shaders supplied by another plugin.

:::

![3D armor created with CraftEngine Toolbox](/img/3darmor.png)
